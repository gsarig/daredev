...
function daredev_register_theme_customizer( $wp_customize ) {
	...
	// API Keys
	$wp_customize->add_section( 'dd_api_keys', array(
	...
	$wp_customize->add_control( new WP_Customize_Control(
			...
			array(
				...
				'description' => __( 'See how you can get your Google Maps API key <a href="https://developers.google.com/maps/documentation/embed/get-api-key" target="_blank">here</a> (Opens in new window).', 'daredev' ),
				'section'     => 'dd_api_keys',
	...
	// Header Scripts
	$wp_customize->add_section( 'dd_header_scripts', array(
	...
	// Add setting
	$wp_customize->add_setting( 'dd_header_scripts', array(
		'default' => '',
	) );
	// Add control
	$wp_customize->add_control( new WP_Customize_Control(
	...
	// Body Scripts
	$wp_customize->add_section( 'dd_body_scripts', array(
		'title'       => __( 'Body scripts', 'daredev' ),
		'description' => __( 'Scripts that go right after the <code>&lt;body&gt;</code> of your site.', 'daredev' ),
		'panel'       => 'text_blocks',
		'priority'    => 10,
	) );
	// Add setting
	$wp_customize->add_setting( 'dd_body_scripts', array(
		'default' => '',
	) );
	// Add control
	$wp_customize->add_control( new WP_Customize_Control(
	...
	// Footer Scripts
	$wp_customize->add_section( 'dd_footer_scripts', array(
		'title'       => __( 'Footer scripts', 'daredev' ),
		'description' => __( 'Scripts that go right before the <code>&lt;/body&gt;</code> of your site.', 'daredev' ),
		'panel'       => 'text_blocks',
		'priority'    => 10,
	) );
	// Add setting
	$wp_customize->add_setting( 'dd_footer_scripts', array(
		'default' => '',
	) );
	// Add control
	$wp_customize->add_control( new WP_Customize_Control(
