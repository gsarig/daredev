    ...
    SliderPro.prototype = {
        ...
        _updateSlidesPosition: function () {
            ...
            setTimeout(function () {
                ...
                var selectedSlidePixelPosition = parseInt(_this.$slides.find('.sp-slide').eq(_this.selectedSlideIndex).css(_this.positionProperty), 10);

                for (var slideIndex = 0; slideIndex < _this.slidesOrder.length; slideIndex++) {
                    var slide = _this.$slides.find('.sp-slide').eq(_this.slidesOrder[slideIndex]);
                    slide.css(_this.positionProperty, selectedSlidePixelPosition + ( slideIndex - _this.middleSlidePosition  ) * ( _this.slideSize + _this.settings.slideDistance ));
                }
            }, 1000);
        },
